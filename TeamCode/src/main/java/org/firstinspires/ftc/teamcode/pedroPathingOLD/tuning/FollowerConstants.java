...
import org.firstinspires.ftc.teamcode.pedroPathingOLD.util.CustomFilteredPIDFCoefficients;
import org.firstinspires.ftc.teamcode.pedroPathingOLD.util.CustomPIDFCoefficients;
import org.firstinspires.ftc.teamcode.pedroPathingOLD.util.KalmanFilterParameters;
...
public class FollowerConstants {
    ...
    private static double xMovement = 4.9;
    private static double yMovement = 65;
    ...
    public static double forwardZeroPowerAcceleration = -32;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -61;
