...
import org.firstinspires.ftc.teamcode.pedroPathingOLD.localization.GoBildaPinpointDriver;
 ...
 *                         \--------------/
 *
 * @author Anyi Lin - 10158 Scott's Bots+botics
...
public class TwoWheelPinpointIMULocalizer extends Localizer {
    ...
    public TwoWheelPinpointIMULocalizer(HardwareMap map, Pose setStartPose) {
        ...
        strafeEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "rightFront")); // strafeEncoder
