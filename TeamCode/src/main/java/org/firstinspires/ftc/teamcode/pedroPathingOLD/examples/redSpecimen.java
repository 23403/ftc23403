...
@Autonomous(name = "Auto Red Specimen", group = "Examples")
public class redSpecimen extends OpMode {
    ...
    private final Pose startPose = new Pose(135, 95, Math.toRadians(0));

    private final Pose scorePose = new Pose(85, 80, Math.toRadians(0));

    private final Pose parkPose = new Pose(135, 125, Math.toRadians(0));
