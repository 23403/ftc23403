...
@Autonomous(name = "Auto Blue Specimen", group = "Examples")
public class BlueSpecimen extends OpMode {
    ...
    private final Pose startPose = new Pose(10, 55);

    private final Pose scorePose = new Pose(60, 65);

    private final Pose parkPose = new Pose(14, 20);
