...
public class ThreeWheelIMULocalizer extends Localizer {
    ...
    public static double STRAFE_TICKS_TO_INCHES = -0.0035;//8192 * 1.37795 * 2 * Math.PI * 0.5018874659;
    ...
    public ThreeWheelIMULocalizer(HardwareMap map, Pose setStartPose) {
        ...
        leftEncoderPose = new Pose(0.0, 8.0, 0);
        rightEncoderPose = new Pose(0.0, -8.0, 0);
        strafeEncoderPose = new Pose(0.0, 0.0, Math.toRadians(90));
