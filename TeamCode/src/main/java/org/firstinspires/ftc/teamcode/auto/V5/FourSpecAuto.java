...
import org.firstinspires.ftc.teamcode.auto.V5.paths.FourSpecimenAutoPaths;
...
public class FourSpecAuto extends OpMode {
        ...
        switch (pathState) {
            ...
            case 1: /* line2 */
                if (!grabSpecimen1Started) {
                    presets.humanPlayer();
                    follower.followPath(FourSpecimenAutoPaths.grabSpecimen1(), false);
            ...
            case 2: /* line3 */
                if (!scoreSpecimen1Started) {
                    presets.scoreStage1();
                    follower.followPath(FourSpecimenAutoPaths.scoreSpecimen1(), false);
            ...
            case 3: /* line4 */
                if (!pushBlock1Started) {
                    presets.transition();
                    follower.followPath(FourSpecimenAutoPaths.pushBlock1(), true);
                    pushBlock1Started = true;
                }
                if (!follower.isBusy() || (Math.abs(follower.getPose().getX() - FourSpecimenAutoPaths.pushBlock1Points.endPointX) < 2 && Math.abs(follower.getPose().getY() - FourSpecimenAutoPaths.pushBlock1Points.endPointY) < 2)) {
                    setPathState(999);
                }
                break;
            case 999: /* line4a */
                if (!pushBlock2Started) {
                    follower.followPath(FourSpecimenAutoPaths.pushBlock2(), true);
                    pushBlock2Started = true;
                }
                if (!follower.isBusy() || (Math.abs(follower.getPose().getX() - FourSpecimenAutoPaths.pushBlock2Points.endPointX) < 3 && Math.abs(follower.getPose().getY() - FourSpecimenAutoPaths.pushBlock2Points.endPointY) < 2)) {
                    Timer.wait(pauses);
                    setPathState(998);
                }
                break;
            case 998: /* line4b */
                if (!pushBlock3Started) {
                    presets.humanPlayer();
                    follower.followPath(FourSpecimenAutoPaths.pushBlock3(), true);
            ...
            case 4: /* line5 */
                if (!scoreSpecimen2Started) {
                    presets.scoreStage1();
                    follower.followPath(FourSpecimenAutoPaths.scoreSpecimen2(), false);
            ...
            case 5: /* line6 */
                if (!grabSpecimen2Started) {
                    presets.humanPlayer();
                    follower.followPath(FourSpecimenAutoPaths.grabSpecimen2(), false);
            ...
            case 6: /* line7 */
                if (!scoreSpecimen3Started) {
                    presets.scoreStage1();
                    follower.followPath(FourSpecimenAutoPaths.scoreSpecimen3(), false);
            ...
            case 7: /* line8 */
                if (!parkStarted) {
                    presets.transition();
                    follower.followPath(FourSpecimenAutoPaths.park(), false);
                    parkStarted = true;
                }
                if (follower.isBusy() && angleDiffDegrees(Math.toDegrees(follower.getPose().getHeading()), FourSpecimenAutoPaths.parkPoints.getEndHeading()) <= 2) submersible.subFull();
    ...
    private static class presets {
        public static void scoreBack() {
            ...
            arm(0.8);
            wrist1(0.18);
            FourSpecAuto.claw.close(1);
        }
        public static void scoreStage1() {
            extendArmMove(10);
            FourSpecAuto.submersible.subIn();
            wrist1(0.6);
            arm(0.23);
            FourSpecAuto.claw.close(1);
        }
        ...
        public static void humanPlayer() {
            ...
            wrist1(0.42);
            arm(0.96);
            FourSpecAuto.claw.open(0);
        }
        public static void park() {
            extendArmMove(0);
            FourSpecAuto.submersible.subFull();
            wrist2(0.9);
            wrist1(0.5);
            arm(0.18);
            rotation(0.52);
    ...
    public void init() {
        ...
        follower.setStartingPose(FourSpecimenAutoPaths.startPos);
        // Draw the robot on the dashboard
        poseUpdater = new PoseUpdater(hardwareMap);
        poseUpdater.setStartingPose(FourSpecimenAutoPaths.startPos);
