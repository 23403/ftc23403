...
import org.firstinspires.ftc.teamcode.pedroPathingOLD.follower.*;
...
import org.firstinspires.ftc.teamcode.pedroPathingOLD.util.Timer;


@Autonomous(name = "Auto Blue Bucket", group = "Examples")
...
public class ExampleBucketAuto extends OpMode {
    ...
    private final Pose startPose = new Pose(10, 90, Math.toRadians(0));

    private final Pose scorePose = new Pose(63, 75, Math.toRadians(0));

    private final Pose parkPose = new Pose(14, 100, Math.toRadians(0));
